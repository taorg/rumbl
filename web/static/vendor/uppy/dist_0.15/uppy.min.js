...
"use strict";var _appendChild=require("yo-yoify/lib/appendChild"),ActionBrowseTagline=require("./ActionBrowseTagline"),_require=require("./icons"),localIcon=_require.localIcon;module.exports=function(e){var t,a,n,r,i,s,l,c=0===Object.keys(e.files).length;if(0===e.acquirers.length){var u,d;return d=document.createElement("div"),d.setAttribute("aria-hidden",""+String(c)),d.setAttribute("class","UppyDashboardTabs"),_appendChild(d,[" ",(u=document.createElement("h3"),u.setAttribute("class","UppyDashboardTabs-title"),_appendChild(u,[" ",ActionBrowseTagline({acquirers:e.acquirers,handleInputChange:e.handleInputChange,i18n:e.i18n})," "]),u)," "]),d}var p=(t=document.createElement("input"),t.setAttribute("type","file"),t.setAttribute("name","files[]"),t.setAttribute("multiple","true"),t.onchange=e.handleInputChange,t.setAttribute("class","UppyDashboard-input"),t);return l=document.createElement("div"),l.setAttribute("class","UppyDashboardTabs"),_appendChild(l,[" ",(s=document.createElement("nav"),_appendChild(s,[" ",(i=document.createElement("ul"),i.setAttribute("role","tablist"),i.setAttribute("class","UppyDashboardTabs-list"),_appendChild(i,[" ",(r=document.createElement("li"),r.setAttribute("class","UppyDashboardTab"),_appendChild(r,[" ",(n=document.createElement("button"),n.setAttribute("type","button"),n.setAttribute("role","tab"),n.setAttribute("tabindex","0"),n.onclick=function(e){p.click()},n.setAttribute("class","UppyDashboardTab-btn UppyDashboard-focus"),_appendChild(n,[" ",localIcon()," ",(a=document.createElement("h5"),a.setAttribute("class","UppyDashboardTab-name"),_appendChild(a,[e.i18n("localDisk")]),a)," "]),n)," ",p," "]),r)," ",e.acquirers.map(function(t){var a,n,r;return r=document.createElement("li"),r.setAttribute("class","UppyDashboardTab"),_appendChild(r,[" ",(n=document.createElement("button"),n.setAttribute("role","tab"),n.setAttribute("tabindex","0"),n.setAttribute("aria-controls","UppyDashboardContent-panel--"+String(t.id)),n.setAttribute("aria-selected",""+String(t.isHidden?"false":"true")),n.onclick=function(){return e.showPanel(t.id)},n.setAttribute("class","UppyDashboardTab-btn"),_appendChild(n,[" ",t.icon()," ",(a=document.createElement("h5"),a.setAttribute("class","UppyDashboardTab-name"),_appendChild(a,[t.name]),a)," "]),n)," "]),r})," "]),i)," "]),s)," "]),l};
...
"use strict";function isModeAvailable(e,t){return-1!==e.indexOf(t)}var _appendChild=require("yo-yoify/lib/appendChild"),_onload=require("on-load"),SnapshotButton=require("./SnapshotButton"),RecordButton=require("./RecordButton");module.exports=function(e){var t,o,n,a,i=e.src||"",d=void 0;if(e.useTheFlash)d=e.getSWFHTML();else{var r;r=document.createElement("video"),r.setAttribute("autoplay","autoplay"),r.setAttribute("src",""+String(i)),r.setAttribute("class","UppyWebcam-video"),d=r}var s=e.supportsRecording&&(isModeAvailable(e.modes,"video-only")||isModeAvailable(e.modes,"audio-only")||isModeAvailable(e.modes,"video-audio")),u=isModeAvailable(e.modes,"picture");return a=document.createElement("div"),_onload(a,function(t){e.onFocus(),document.querySelector(".UppyWebcam-recordButton").focus()},function(t){e.onStop()},6),a.setAttribute("class","UppyWebcam-container"),_appendChild(a,[" ",(t=document.createElement("div"),t.setAttribute("class","UppyWebcam-videoContainer"),_appendChild(t,[" ",d," "]),t)," ",(o=document.createElement("div"),o.setAttribute("class","UppyWebcam-buttonContainer"),_appendChild(o,[" ",s?RecordButton(e):null," ",u?SnapshotButton(e):null," "]),o)," ",(n=document.createElement("canvas"),n.setAttribute("style","display: none;"),n.setAttribute("class","UppyWebcam-canvas"),n)," "]),a};
